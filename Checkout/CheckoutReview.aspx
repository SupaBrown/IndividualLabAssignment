<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CheckoutReview.aspx.cs" Inherits="IndividualLabAssignment.Checkout.CheckoutReview" %>
...
(per day)" DataFormatString="{0:c}"/>
 <asp:BoundField DataField="NumberDays" HeaderText="Number of Days" />
