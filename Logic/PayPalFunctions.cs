...
public class NVPAPICaller
{
    ...
    public string APIUsername = "sb-2wlbe3658202_api1.business.example.com";
    private string APIPassword = "9NAEU44Q2CFAHQTV";
    private string APISignature = "A94RwqROd-IojKURHhtodSvLUKQlAbTx9mnJcL4ATXSqy0WJT3put1PF";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        encoder["BRANDNAME"] = "B's Car Rental Application";
        ...
        using (IndividualLabAssignment.Logic.ShoppingCartActions myCartOrders = new IndividualLabAssignment.Logic.ShoppingCartActions())
        {
            ...
            for (int i = 0; i < myOrderList.Count; i++)
            {
                ...
                encoder["L_PAYMENTREQUEST_0_QTY" + i] = myOrderList[i].NumberDays.ToString();
            }
        }
